    ...
    <Fragment>
      <div className='sidenav'>
        <nav className="nav flex-column">
          ...
          <a className="nav-link" href="seguimiento">Otros</a>
          </nav>
      </div>
      <div className='main'>
      <blockquote className="blockquote text-center">
        ...
        <table className="table">
          ...
          <tbody>
              <tr>
                <th scope='row'className="fw-normal parrafo2">1033994774</th>
                <th className="fw-normal parrafo2">06/12/2022</th>
                <th className="fw-normal parrafo2">Barranquilla</th>
        ...
        <p>Su envio esta en proceso de entrega, recuerde que puede cancelar su solicitud hasta 24 horas despues de creada la misma</p>
